...
<html lang="en">
	<head>
		...
		<title>[cad009b.jsp] Cadastro de Programa</title>
...
<body>
	...
	<div class="navbar navbar-fixed-top">
		...
		<es:botoesBrowse codigoPrograma="cad009"/>		
		
	</div>
	
	<div class="container-fluid">
        <div class="container">
            <s:form id="cad009" action="Cad009Action!browser.action" theme="simple" cssClass="well form-horizontal">
	...
	<script type="text/javascript">
		...
		function detalhes(codigo){
			$('#ac').val(' ');
			$('#cad009').attr("action","Cad009Action!crud.action?ac=consultar&codigoProgramaSelecionado="+codigo);
			$('#cad009').submit();
