...
<body>
	...
	<div class="navbar navbar-fixed-top">
		...
		<es:botoesBrowse codigoPrograma="cad005"/>		
		
	</div>

	<div class="container-fluid">
        <div class="container">
            <s:form id="cad005" action="Cad005Action!browser.action" theme="simple" cssClass="well form-horizontal">
			...
			<table width="100%" class="table table-bordered table-striped ">
				...
				<thead>
					<tr>
						...
						<th width="*"><fmt:message key="label.padrao.placa"/></th>
					</tr>
				</thead>
				...
				<tbody>
					<s:iterator  value="listaVeiculo" status="status">
						<tr onclick="javaScript:detalhes('<s:property value="codigoVeiculo" />')">
							<td>
								<a>
									<fmt:formatNumber value="${codigoVeiculo}" type="number"  minIntegerDigits="6" />
								</a>
							</td>
							<td>
								<a><s:property value="placa" /></a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
