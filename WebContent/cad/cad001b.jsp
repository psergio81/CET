...
<body>
	...
	<div class="navbar navbar-fixed-top">
		...
		<es:botoesBrowse codigoPrograma="cad001"/>		
		
	</div>

	<div class="container-fluid">
        <div class="container">
            <s:form id="cad001" action="Cad001Action!browser.action" theme="simple" cssClass="well form-horizontal">
	...
	<div class="container">
		<s:if test="%{listaEmpresa.isEmpty()}">
		    <div class="alert">
